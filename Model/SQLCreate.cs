...
namespace MigrateBase.Model
{
    ...
    class SQLCreate
    {
        ...
        public void CreateTables(IProgress<ProgressIndicate> progress, CancellationToken token)
        {
         ...
         _sql.Create_Приходник(),
         _sql.Create_ПриходникДоговор(),
         _sql.Create_Продажа(),
         _sql.Create_Продукт(),
         _sql.Create_Раздел(),
         _sql.Create_Регион(),
        ...
        public void RelationTables(IProgress<ProgressIndicate> progress, CancellationToken token)
        {
         ...
         _sql.RelationIndex_Договор_ПриходникДоговор(),
         ...
         _sql.RelationIndex_Клиент_Приходник(),
         ...
         _sql.RelationIndex_Приходник_Баланс(),
         _sql.RelationIndex_Приходник_ПриходникДоговор(),
         ...
         _sql.RelationIndex_ТипПРО_Приходник(),
